...
public class DialogWin78 extends JFrame implements ActionListener,WindowListener,KeyListener
{
    ...
    private Dialog78 myDialog;
    public JButton send;
    private String myName = "Your";
    private String otherName = "Client";

    public DialogWin78(String header, Dialog78 myDialog)
    {
        super(header);
